  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response) throws java.io.IOException, ServletException {
    ...
    */
    ...
    try {
        ...
        if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
        {
          do {
            ...
            /*@lineinfo:translated-code*//*@lineinfo:20^9*/            {
              ...
              __jsp_taghandler_3.setKey("username.prompt");
            ...
            /*@lineinfo:translated-code*//*@lineinfo:21^9*/            {
              ...
              __jsp_taghandler_4.setProperty("username");
          ...
          /*@lineinfo:translated-code*//*@lineinfo:29^33*/          } while (__jsp_taghandler_2.doAfterBody()==javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_AGAIN);
        }
      ...
      /*@lineinfo:user-code*//*@lineinfo:33^1*/      out.print( new java.util.Date() );
      /*@lineinfo:generated-code*/
